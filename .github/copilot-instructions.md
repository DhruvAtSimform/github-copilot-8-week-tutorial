...
> **Note**: Use separate `.github//instructions/copilot-instructions-*.md` files with `applyTo` glob patterns for feature-specific instructions (e.g., API routes, database models, auth).
